...
namespace WebBanHangOnline.Data
{
    public static class SeedData
    {
        ...
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            var adminEmail = "ngmanhcuong2011@gmail.com";
            ...
            if (adminUser == null)
            {
                ...
                {
                    UserName = "cuongnguyen2011", // Tên đăng nhập là duy nhất
                    Email = adminEmail,
                ...
                var result = await userManager.CreateAsync(newAdminUser, "cuong0203");
